...
class AppointmentBooking
{
	...
	{
		doctorName.add("Rajoni Akter");
		doctorName.add("Shohan");
		doctorName.add("Saika Tabassum");
		doctorName.add("Kamrul Hasan");
		doctorName.add("Tawrat");
		doctorName.add("Maisha");
		doctorName.add("Anila");
		...
		doctorPassword.add("R123");
		doctorPassword.add("Sh123");
		doctorPassword.add("S123");
		doctorPassword.add("k123");
		doctorPassword.add("T123");
		doctorPassword.add("M123");
		...
		doctorCity.add("Pabna");
		doctorCity.add("CTG");
		doctorCity.add("Dhaka");
		doctorCity.add("Sylhet");
		doctorCity.add("Rajsahi");
		doctorCity.add("Dhaka");
		doctorCity.add("Khulna");
